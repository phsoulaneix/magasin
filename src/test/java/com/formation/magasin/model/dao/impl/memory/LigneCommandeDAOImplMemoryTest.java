 ...
 */
public class LigneCommandeDAOImplMemoryTest {
	...
	public void setUp() throws Exception {
		ligneCommandeDAO = new LigneCommandeDAOImplMemory();
	}
	...
	public void testCreate() {
		try {
			...
			final LigneCommande ligneCommandeOk = new LigneCommandeMemory(1,
					article, 2);
			final Boolean createLigneCommandeOk = ligneCommandeDAO
					.create(ligneCommandeOk);
			Assert.assertTrue(createLigneCommandeOk);

			final LigneCommande ligneCommandeKoId = new LigneCommandeMemory(
					null, article, 2);
	...
	public void testDelete() {
		try {
			...
			final LigneCommande ligneCommandeOk1 = new LigneCommandeMemory(1,
					article, 2);
			final LigneCommande ligneCommandeOk2 = new LigneCommandeMemory(2,
					article, 2);
			final LigneCommande ligneCommandeOk3 = new LigneCommandeMemory(3,
					article, 2);
			...
			final LigneCommande ligneCommandeNotCreate = new LigneCommandeMemory(
					4, article, 2);
			final Boolean delete2 = ligneCommandeDAO
					.delete(ligneCommandeNotCreate);
			Assert.assertFalse(delete2);

			final LigneCommande ligneCommandeIdNull = new LigneCommandeMemory(
					null, article, 2);
