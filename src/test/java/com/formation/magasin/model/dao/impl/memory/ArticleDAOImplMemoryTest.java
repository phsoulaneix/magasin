...
public class ArticleDAOImplMemoryTest {
	...
	public void setUp() throws Exception {
		articleDAO = new ArticleDAOImplMemory();
	}
	...
	public void testCreate() {
		...
		try {
			// Article OK
			final Article articleCreate = new ArticleMemory(1, "article 1", 10);
			...
			// Id null
			final Article articleIdNull = new ArticleMemory(null,
					"article null", 10);
	...
	public void testDelete() {
		try {
			final Article articleCreate1 = new ArticleMemory(1, "Article 1", 10);
			final Article articleCreate2 = new ArticleMemory(2, "Article 2", 10);
			final Article articleCreate3 = new ArticleMemory(3, "Article 2", 10);
			...
			final Article articleNotCreate = new ArticleMemory(4, "Article 2",
					10);
	...
	public void testUpdate() throws SQLException {
		...
		final Article articleCreateAndSetNom = new ArticleMemory(2,
				"article 1", 10);
		...
		final Article articleCreateAndSetIdNull = new ArticleMemory(3,
				"article 1", 10);
		...
		// Id null
		final Article articleIdNull = new ArticleMemory(null, "article null",
				10);
		final Boolean update5 = articleDAO.delete(articleIdNull);
		Assert.assertFalse(update5);

		// Id no create
		final Article articleNotCreate = new ArticleMemory(6, "article", 10);
