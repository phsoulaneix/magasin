...
/**
 * The Class ClientDAOImplMemoryTest.
 */
public class ClientDAOImplMemoryTest {
	...
	public void setUp() throws Exception {
		clientDAO = new ClientDAOImplMemory();
	}
	...
	public void testCreate() {
		try {
			...
			final Client clientOk = new ClientMemory(1, "nom", "prenom");
			final Boolean createClientOk = clientDAO.create(clientOk);
			Assert.assertTrue(createClientOk);

			final Client clientKoId = new ClientMemory(null, "nom", "prenom");
	...
	public void testDelete() {
		try {
			final Client clientOk1 = new ClientMemory(1, "nom", "prenom");
			final Client clientOk2 = new ClientMemory(2, "nom", "prenom");
			final Client clientOk3 = new ClientMemory(3, "nom", "prenom");
			...
			final Client clientNotCreate = new ClientMemory(4, "nom", "prenom");
			final Boolean delete2 = clientDAO.delete(clientNotCreate);
			Assert.assertFalse(delete2);

			final Client clientIdNull = new ClientMemory(null, "nom", "prenom");
